...
def personatom_periodic_table0() -> plotly_Figure:
    ...
    person_contactunit_insert = get_insert_rect("person_contactunit")
    person_contact_membership_insert = get_insert_rect("person_contact_membership")
    person_planunit_insert = get_insert_rect("person_planunit")
    person_plan_awardunit_insert = get_insert_rect("person_plan_awardunit")
    person_plan_laborunit_insert = get_insert_rect("person_plan_laborunit")
    ...
    person_contactunit_update = get_update_rect("person_contactunit")
    person_contact_membership_update = get_update_rect("person_contact_membership")
    ...
    person_plan_laborunit_delete = get_delete_rect("person_plan_laborunit")
    ...
    person_contact_membership_delete = get_delete_rect("person_contact_membership")
    person_contactunit_delete = get_delete_rect("person_contactunit")
    personunit_update = get_update_rect("personunit")

    green_str = "Green"
    person_contactunit_insert.set_level(0, 0, 0.25, green_str)
    person_contactunit_update.set_level(0, 0.25, 0.75, green_str)
    person_contactunit_delete.set_level(0, 0.75, 1, green_str)
    person_contact_membership_insert.set_level(1, 0, 0.3, green_str)
    person_contact_membership_update.set_level(1, 0.3, 0.7, green_str)
    person_contact_membership_delete.set_level(1, 0.7, 1, green_str)
    person_plan_healerunit_insert.set_level(3, 0.2, 0.4)
    person_plan_healerunit_delete.set_level(3, 0.6, 0.8)
    person_plan_laborunit_insert.set_level(4, 0.2, 0.4)
    person_plan_laborunit_delete.set_level(4, 0.6, 0.8)
    ...
    # person_plan_laborunit_insert = get_insert_rect(kw.person_plan_laborunit)
    ...
    # person_plan_laborunit_delete = get_delete_rect(kw.person_plan_laborunit)
    ...
    # Add shapes
    add_atom_rect(fig, person_contactunit_insert)
    add_atom_rect(fig, person_contact_membership_insert)
    add_atom_rect(fig, person_plan_laborunit_insert)
    ...
    add_atom_rect(fig, person_contactunit_update)
    add_atom_rect(fig, person_contact_membership_update)
    ...
    add_atom_rect(fig, person_plan_laborunit_delete)
    ...
    add_atom_rect(fig, person_contact_membership_delete)
    add_atom_rect(fig, person_contactunit_delete)
