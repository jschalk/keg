...
def test_get_atom_config_dict_CheckPersonConfigArgs():
    ...
    prnptnr_k_args = person_config_jkeys(p_config, kw.person_contactunit)
    ...
    prnptnr_v_args = person_config_jvalues(p_config, kw.person_contactunit)
    ...
    assert prnptnr_k_args == atom_config_k_args(kw.person_contactunit)
    ...
    assert prnptnr_v_args == atom_config_v_args(kw.person_contactunit)
