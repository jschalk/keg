    ...
    if graphics_bool:
        ...
        fig.add_trace(
            plotly_Scatter(
                ...
                y=[9.0, 8.75],
                text=[
                    "momentity Person Listening Structures",
                    "The gut person listens to other's job persons and builds a new person from itself and others",
                ],
                mode="text",
            )
        )
    ...
    if graphics_bool:
        ...
        fig.add_trace(
            plotly_Scatter(
                x=[2.0],
                y=[13],
                text=["Person Listening Structures"],
                mode="text",
            )
        )
...
def fund_graph13(
    ...
    purple_str = "purple"
    add_simp_rect(fig, 9, -0.4, 9.75, 0.2, contactunit_str, purple_str)
    add_simp_rect(fig, 9, -1.0, 9.75, -0.4, contactunit_str, purple_str)
    add_simp_rect(fig, 9, -1.6, 9.75, -1.0, contactunit_str, purple_str)
    add_simp_rect(fig, 9, -2.2, 9.75, -1.6, contactunit_str, purple_str)
    add_simp_rect(fig, 9, -4.0, 9.75, -2.2, contactunit_str, purple_str)
