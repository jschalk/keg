...
def test_RiverRun_set_contact_need_due_SetsAttr(temp3_dir):
    # ESTABLISH
    mstr_dir = temp3_dir
    ...
    # WHEN
    yao_need_due = 7
    bob_riverrun.set_contact_need_due(exx.yao, yao_need_due)
...
def test_RiverRun_need_dues_unpaid_ReturnsObj(temp3_dir):
    ...
    # WHEN
    yao_need_due = 500
    x_riverrun.set_contact_need_due(exx.yao, yao_need_due)
    # THEN
    ...
    # WHEN
    bob_need_due = 300
    x_riverrun.set_contact_need_due(exx.bob, bob_need_due)
    x_riverrun.set_contact_need_due(exx.yao, yao_need_due)
    # THEN
    assert x_riverrun.need_dues_unpaid()
...
def test_RiverRun_contact_has_need_due_ReturnsBool():
    # ESTABLISH
    bob_mana_amount = 1000
    bob_mana_grain = 1
    bob_riverrun = riverrun_shop(
    ...
    assert bob_riverrun.contact_has_need_due(exx.yao) is False
    assert bob_riverrun.contact_has_need_due(exx.zia) is False

    # WHEN
    bob_riverrun.set_need_dues(bob_doctorledger)

    # THEN
    assert bob_riverrun.contact_has_need_due(exx.bob)
    assert bob_riverrun.contact_has_need_due(exx.sue)
    assert bob_riverrun.contact_has_need_due(exx.yao)
    assert bob_riverrun.contact_has_need_due(exx.zia) is False
...
def test_RiverRun_delete_need_due_SetsAttr():
    ...
    bob_riverrun.set_contact_need_due(exx.yao, 5)
    assert bob_riverrun.contact_has_need_due(exx.yao)
...
def test_RiverRun_get_contact_need_due_ReturnsObj():
    # ESTABLISH
    bob_mana_amount = 1000
    bob_mana_grain = 1
    bob_riverrun = riverrun_shop(
