...
from ch17_brick.brick_dataframe import (
...
def test_config_str_functions_ReturnsObj():
    ...
    x00021_brick = "bk00121_person_contactunit_v0_0_0"
    assert ifx.bk00121_person_contactunit_v0_0_0 == x00021_brick
    x00020_brick = "bk00120_person_contact_membership_v0_0_0"
    assert ifx.bk00120_person_contact_membership_v0_0_0 == x00020_brick
    x0003_brick = "bk00002_planunit_v0_0_0"
    assert ifx.bk00002_planunit_v0_0_0 == x0003_brick
...
def test_get_brick_formats_dir_ReturnsObj():
    ...
    src_chapter_dir = create_path("src", "ch17_brick")
...
def test_get_brickref_obj_ReturnsObj():
    # ESTABLISH
    ifx = BrickFormatsEnum
    brick_name_00021 = ifx.bk00121_person_contactunit_v0_0_0
...
def test_get_headers_list_ReturnsObj():
    ...
    ifx = BrickFormatsEnum
    # WHEN
    format_00021_headers = _get_headers_list(ifx.bk00121_person_contactunit_v0_0_0)
...
def get_sorted_headers_str(brick_filename):
    ...
    brick_attributes = set(x_brickref.get(kw.attributes).keys())
    ...
    return header_str[1:]
    # return create_sorted_planatenated_str(list(brick_attributes))


def test_get_sorted_headers_str_ReturnsObj_Scenario0_SingleExample():
    # ESTABLISH
    ifx = BrickFormatsEnum
    filebasename = ifx.bk00121_person_contactunit_v0_0_0
...
def test_get_sorted_headers_str_ReturnsObj_Scenario1_SingleExample():
    ...
    ifx = BrickFormatsEnum
    # WHEN
    bk00119_headers = get_sorted_headers_str(ifx.bk00119_planunit_v0_0_0)

    # THEN
    print(f"{bk00119_headers=}")
    ...
    assert bk00119_headers == expected_plan_headers_str
...
def test__generate_brick_dataframe_ReturnsObj():
    ...
    ifx = BrickFormatsEnum
    # WHEN
    x_df = _generate_brick_dataframe(empty_d2, ifx.bk00121_person_contactunit_v0_0_0)
    # THEN
    headers_list = _get_headers_list(ifx.bk00121_person_contactunit_v0_0_0)
...
def test_get_brickref_obj_HasAttrs_bk00121_person_contactunit_v0_0_0():
    # ESTABLISH
    ifx = BrickFormatsEnum
    brick_name = ifx.bk00121_person_contactunit_v0_0_0

    # WHEN
    format_00121_brickref = get_brickref_obj(brick_name)
    ...
    headers_list = format_00121_brickref.get_headers_list()
...
def test_get_brickref_obj_HasAttrs_bk00120_person_contact_membership_v0_0_0():
    # ESTABLISH
    ifx = BrickFormatsEnum
    brick_name = ifx.bk00120_person_contact_membership_v0_0_0
...
def test_get_brickref_obj_HasAttrs_bk00002_planunit_v0_0_0():
    # ESTABLISH
    ifx = BrickFormatsEnum
    brick_name = ifx.bk00002_planunit_v0_0_0
...
def test_get_brickref_obj_HasAttrs_bk00119_planunit_v0_0_0():
    # ESTABLISH
    ifx = BrickFormatsEnum
    brick_name = ifx.bk00119_planunit_v0_0_0
...
def test_get_dimen_minimum_put_brick_names_ReturnsObj():
    ...
    brick_config_dimens = set(brick_config_dict.keys())
    # print(f"{brick_config_dimens=}")
    assert dimen_minimum_keys == brick_config_dimens
    for brick_dimen, dimen_config in brick_config_dict.items():
        brick_name = dimen_minimum_put_brick_names.get(brick_dimen)
        format_brickref = get_brickref_obj(brick_name)

        print(f"{brick_dimen=} {format_brickref.brick_name=}")
...
def test_get_dimen_minimum_del_brick_names_ReturnsObj():
    ...
    brick_config_dimens = {
        brick_dimen
        for brick_dimen, dimen_config in brick_config_dict.items()
        if dimen_config.get(kw.brick_category) == kw.person
    }
    print(f"{brick_config_dimens=}")
    assert dimen_minimum_keys == brick_config_dimens
    for brick_dimen in brick_config_dimens:
        dimen_config = brick_config_dict.get(brick_dimen)
        brick_name = dimen_minimum_del_brick_names.get(brick_dimen)
        format_brickref = get_brickref_obj(brick_name)
