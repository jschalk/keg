...
def test_create_brick_df_Arg_bk00120_person_contact_membership_v0_0_0():
    # ESTABLISH
    amy_moment_rope = create_rope("amy56")
    sue_personunit = personunit_shop(exx.sue, amy_moment_rope)
    ...
    # WHEN
    x_brick_name = BrickFormatsEnum.bk00120_person_contact_membership_v0_0_0
...
def test_create_brick_df_Arg_bk00002_planunit_v0_0_0():
    # ESTABLISH
    amy_moment_rope = create_rope("amy56")
    sue_personunit = personunit_shop(exx.sue, amy_moment_rope)
...
def test_save_brick_csv_Arg_bk00119_planunit_v0_0_0():
    # ESTABLISH
    ...
    x_brick_name = BrickFormatsEnum.bk00119_planunit_v0_0_0

    # WHEN
    # name_filename = f"{exx.sue}_planunit_example_00019.csv"
    # csv_example_path = create_path(str(temp3_fs), name_filename)
    # save_brick_csv(x_brick_name, sue_personunit,, name_filename)
    brick_df = create_brick_df(sue_personunit, x_brick_name)
...
def test_save_brick_csv_Arg_bk00121_person_contactunit_v0_0_0_SaveToCSV(
    temp3_fs,
):
    # ESTABLISH
    sue_contact_cred_lumen = 11
...
,,;amy56;,Sue,Yao,41,37,
"""
    brick_file_str = open_file(str(temp3_fs), name_filename)
...
def test_save_brick_csv_Arg_bk00002_planunit_v0_0_0(
    temp3_fs,
):
    # ESTABLISH
    amy_moment_rope = create_rope("amy56")
    ...
    # WHEN
    save_brick_csv(x_brick_name, sue_personunit, str(temp3_fs), name_filename)
