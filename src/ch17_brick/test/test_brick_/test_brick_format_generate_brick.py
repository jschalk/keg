...
# def test_make_persondelta_Arg_bk00120_person_contact_membership_v0_0_0():
#     # ESTABLISH
#     exx.bob = "Bob"
#     exx.yao = exx.yao
#     amy_moment_rope = create_rope("amy56")
...
def test_make_persondelta_Arg_bk00002_planunit_v0_0_0():
    # sourcery skip: extract-duplicate-method
    # ESTABLISH
    amy_moment_rope = create_rope("amy56")
    sue_personunit = personunit_shop(exx.sue, amy_moment_rope)
...
def test_create_brick_df_Arg_bk00002_planunit_v0_0_0_Scenario_personunit_v001(
    run_big_tests,
):
