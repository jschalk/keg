...
def test_get_brick_into_dimen_raw_query_ReturnsObj_Scenario0_person_plan_laborunit(
    ...
    prnlabo_config = brick_config.get(prnlabo_cat)
    print(f"{prnlabo_cat=}")
    ...
    create_brick_sorted_table(cursor0, src_table, brick_cols)
    create_brick_sorted_table(cursor0, dst_table, prnlabo_args)
...
def test_get_brick_into_dimen_raw_query_ReturnsObj_Scenario1_person_contactunit(
    ...
    brick_config = get_brick_config_dict()
    prncont_config = brick_config.get(kw.person_contactunit)
    ...
    create_brick_sorted_table(cursor0, src_table, brick_cols)
    create_brick_sorted_table(cursor0, prncont_table, list(prncont_args))
