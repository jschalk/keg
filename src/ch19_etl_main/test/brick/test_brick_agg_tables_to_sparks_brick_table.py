...
"""
    ...
    # WHEN
    etl_brick_agg_tables_to_sparks_brick_agg_table(cursor0)
...
def test_etl_sparks_brick_agg_db_to_spark_dict_ReturnsObj_Scenario0(cursor0: Cursor):
    # ESTABLISH
    spark1 = 1
    spark3 = 3
    spark9 = 9
...
"""
    ...
    # WHEN
    sparks_dict = etl_sparks_brick_agg_db_to_spark_dict(cursor0)
