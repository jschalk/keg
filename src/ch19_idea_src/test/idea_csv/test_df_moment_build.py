...
def test_moment_build_from_df_ReturnsObj_Scenario0_OneMomentRope(
    ...
    # ESTABLISH
    bk00100_df = get_ex1_bk00100_df()
    bk00101_df = get_ex1_bk00101_df()
    bk00102_df = get_ex1_bk00102_df()
    bk00103_df = get_ex1_bk00103_df()
    bk00104_df = get_ex1_bk00104_df()
    bk00105_df = get_ex1_bk00105_df()
    x_fund_grain = 55
    x_respect_grain = 66
    x_mana_grain = 77
