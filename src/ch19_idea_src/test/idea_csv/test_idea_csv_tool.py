...
def test_create_init_idea_csv_strs_ReturnsObj_Scenario0_EmptyMomentUnit(
    ...
    # WHEN
    x_ideas = create_init_idea_csv_strs()
    ...
    expected_ii00100_csv = expected_idea_csv_strs.get("ii00100")
    expected_ii00101_csv = expected_idea_csv_strs.get("ii00101")
    expected_ii00102_csv = expected_idea_csv_strs.get("ii00102")
    expected_ii00103_csv = expected_idea_csv_strs.get("ii00103")
    expected_ii00104_csv = expected_idea_csv_strs.get("ii00104")
    expected_ii00105_csv = expected_idea_csv_strs.get("ii00105")
    # expected_ii00106_csv = expected_idea_csv_strs.get("ii00106")
    expected_ii00120_csv = expected_idea_csv_strs.get("ii00120")
    expected_ii00121_csv = expected_idea_csv_strs.get("ii00121")
    expected_ii00122_csv = expected_idea_csv_strs.get("ii00122")
    expected_ii00123_csv = expected_idea_csv_strs.get("ii00123")
    expected_ii00124_csv = expected_idea_csv_strs.get("ii00124")
    expected_ii00125_csv = expected_idea_csv_strs.get("ii00125")
    expected_ii00126_csv = expected_idea_csv_strs.get("ii00126")
    expected_ii00127_csv = expected_idea_csv_strs.get("ii00127")
    expected_ii00128_csv = expected_idea_csv_strs.get("ii00128")
    expected_ii00129_csv = expected_idea_csv_strs.get("ii00129")
    expected_ii00142_csv = expected_idea_csv_strs.get("ii00142")
    expected_ii00143_csv = expected_idea_csv_strs.get("ii00143")
    expected_ii00144_csv = expected_idea_csv_strs.get("ii00144")
    expected_ii00145_csv = expected_idea_csv_strs.get("ii00145")
...
def test_add_momentunit_to_idea_csv_strs_ReturnsObj_Scenario0_OneMomentUnit(
    ...
    csv_delimiter = ","
    x_csvs = create_init_idea_csv_strs()
...
def test_add_momentunits_to_idea_csv_strs_ReturnsObj_Scenario1_TwoMomentUnits(
    ...
    # WHEN
    add_momentunits_to_idea_csv_strs(x_momentunits, x_ideas, csv_delimiter)
...
def test_add_personunit_to_idea_csv_strs_ReturnsObj():
    ...
    # WHEN
    bob_person.thinkout()
    add_personunit_to_idea_csv_strs(bob_person, x_ideas, csv_delimiter)
