...
def test_etl_brixk_agg_tables_to_brixk_vld_tables_PopulatesVldTable_Scenario0_valid_spark_nums(
    ...
    insert_into_agg_clause = f"""INSERT INTO {agg_bk00103_tablename} (
  {kw.spark_num}
, {kw.spark_face}
, {kw.moment_rope}
, {kw.cumulative_minute}
...
"""
    ...
    # THEN
    assert db_table_exists(cursor0, vld_bk00103_tablename)
    assert get_row_count(cursor0, vld_bk00103_tablename) == 2

    bk00103_table_cols = get_table_columns(cursor0, vld_bk00103_tablename)
...
def test_etl_brixk_agg_tables_to_brixk_vld_tables_PopulatesVldTable_Scenario1_NoDuplicates(
    cursor0: Cursor,
):  # sourcery skip: extract-duplicate-method
    # ESTABLISH
    spark1 = 1
...
"""
    ...
    # THEN
    assert get_row_count(cursor0, vld_bk00103_tablename) == 3


# def test_etl_brixk_agg_tables_to_brixk_vld_tables_PopulatesVldTable_Scenario1_GroupByOnlyNonConflictingRecords(
#     cursor0: Cursor,
# ):
#     # ESTABLISH
#     spark1 = 1
...
#     # THEN
#     assert db_table_exists(cursor0, vld_bk00103_tablename)
#     assert get_row_count(cursor0, vld_bk00103_tablename) == 1
...
#     assert filename_str not in set(bk00103_table_cols[1])
#     assert sheet_name_str not in set(bk00103_table_cols[2])
#     select_vld_sqlstr = f"""SELECT * FROM {vld_bk00103_tablename};"""
#     cursor0.execute(select_vld_sqlstr)
...
# def test_etl_brixk_agg_tables_to_brixk_vld_tables_PopulatesVldTable_Scenario2_GroupByExcludesRowsWith_error_message(
#     cursor0: Cursor,
# ):
#     # ESTABLISH
#     spark1 = 1
...
# def test_etl_brixk_agg_tables_to_brixk_vld_tables_PopulatesVldTable_Scenario3_TableDeleteBeforeLoad(
#     cursor0: Cursor,
# ):
#     # ESTABLISH
#     spark1 = 1
...
#         kw.error_message,
#     ]
#     create_brick_sorted_table(cursor0, agg_bk00105_tablename, agg_bk00105_columns)
#     insert_into_clause = f"""INSERT INTO {agg_bk00105_tablename} (
#   {kw.spark_num}
# , {kw.spark_face}
# , {kw.moment_rope}
# , {kw.weekday_order}
...
#     etl_brixk_agg_tables_to_brixk_vld_tables(cursor0)
#     assert get_row_count(cursor0, vld_bk00105_tablename) == 3
#     values2_clause = f"""
# VALUES
#   ('{spark1}', '{exx.sue}', '{exx.a23}', 0, '{exx.Wednesday}', ';', NULL)
# , ('{spark1}', '{exx.sue}', '{exx.a23}', 0, '{exx.Wednesday}', ';', NULL)
...
#     assert rows[2] == row2
#     assert rows[3] == row3
#     assert get_row_count(cursor0, vld_bk00105_tablename) == 4
