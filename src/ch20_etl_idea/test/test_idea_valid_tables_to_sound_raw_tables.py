...
from ch20_etl_idea.etl_idea_main import etl_ideax_vld_tables_to_sound_raw_tables
from ref.keywords import Ch20Keywords as kw, ExampleStrs as exx
from sqlite3 import Cursor

# get examples from tests from etl_ideax_agg_dfs_to_translate_title_raw
# get examples from tests from etl_ideax_agg_dfs_to_translate_rope_raw
# get examples from tests from etl_ideax_agg_dfs_to_translate__raw
# get examples from tests from etl_ideax_agg_dfs_to_translate_rope_raw


def test_etl_ideax_vld_tables_to_sound_raw_tables_PopulatesTable_Scenario0_Only_valid_sparks(
    cursor0: Cursor,
):
    # ESTABLISH
    yao_inx = "Yaoito"
...
"""
    ...
    # WHEN
    etl_ideax_vld_tables_to_sound_raw_tables(cursor0)
...
def test_etl_ideax_vld_tables_to_sound_raw_tables_PopulatesTable_Scenario1_NoDuplicates(
    cursor0: Cursor,
):
    # ESTABLISH
    yao_inx = "Yaoito"
