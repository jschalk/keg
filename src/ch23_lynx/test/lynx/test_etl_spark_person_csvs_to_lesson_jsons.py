...
from ch23_lynx.lynx_main import etl_spark_person_csvs_to_lesson_json
...
def test_etl_spark_person_csvs_to_lesson_json_CreatesFiles_Scenario0_IgnoresCSV_personunit(
    ...
    e3_put_csv = f"""{kw.spark_num},{kw.spark_face},moment_rope,person_name,credor_respect,debtor_respect,fund_pool,max_tree_traverse,fund_grain,mana_grain,respect_grain
...
"""
    ...
    # lessons_dir = create_path(fay_wdir.moment_mstr_dir, "lessons")
    # atoms_dir = create_path(fay_wdir.moment_mstr_dir, "atoms")
