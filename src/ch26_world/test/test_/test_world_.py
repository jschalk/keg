...
from ch26_world.world import WorldDir, WorldName, worlddir_shop
...
def test_WorldDir_set_bricks_src_dir_SetsDirsAndFiles(temp3_fs):
    ...
    x_bricks_src_dir = create_path(x_example_dir, kw.b_src)
...
def test_WorldDir_set_world_dirs_SetsDirsAndFiles(temp3_fs):
    ...
    x_bricks_src_dir = create_path(x_world_dir, kw.b_src)
