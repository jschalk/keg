...
from ch27_mind.mind_core import etl_spark_inherited_personunits_to_mind_gut
...
def test_etl_spark_inherited_personunits_to_mind_gut_SetsFiles_Scenario0(
    temp3_fs,
):
    # ESTABLISH
    sue_inx = "Suzy"
    ...
    # WHEN
    etl_spark_inherited_personunits_to_mind_gut(mstr_dir)
