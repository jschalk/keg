...
class ETLApp(tk_Tk):
    ...
    def get_main_rows_config(self) -> dict:
        return {
            ...
            "2": {
                ...
                "var": self._b_src_dir,
                "required": True,
                "tip": "Source of Beliefs. Non-sparked Bricks.",
            },
            "3": {
                "row_type": "dir",
                "title": "BRICKS_DIR  ",
                "var": self._k_src_dir,
                "required": True,
                "tip": "Source of Bricks files. Beliefs that have been sparked.",
            },
            "4": {
                "row_type": "dir",
                "title": "WORKING DIR",
    ...
    def _build_excel_panel(self, parent):
        ...
        self._k_src_dir.trace_add("write", lambda *_: self._refresh_excel_list())
    ...
    def _refresh_excel_list(self):
        ...
        self._excel_paths = {}
        bricks_dir = self._k_src_dir.get().strip()
    ...
    def _run(self):
        ...
        try:
            ...
            _run_btn_str = "▶  CREATE AGENDAS FROM BELIEFS/BRICKS"
    ...
    def create_me_you_today_punchs_and_display(self, me_person: str, you_person: str):
        persons_punchs = create_today_punchs(
            ...
            bricks_src_dir=self._k_src_dir.get(),
        ...
        prettify_excel_files(self._k_src_dir.get())
