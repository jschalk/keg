...
def create_simple_1m2p2pledges_belief_csvs() -> dict[str, str]:
    ...
    return transform_ii00129_into_ii00113_in_csvs(belief_csv_strs, mmt01_rope)
...
def create_simple_2m2p5pledges_belief_csvs() -> dict[str, str]:
    ...
    return transform_ii00129_into_ii00113_in_csvs(belief_csv_strs, heart01_rope)
...
def create_emmanuel_lovemaking_belief_csvs() -> dict[str, str]:
    ...
    emman_person.conpute()
    add_personunit_to_belief_csv_strs(emman_person, belief_csv_strs, ",")
    return transform_ii00129_into_ii00113_in_csvs(belief_csv_strs, mlove01_rope)


def transform_ii00129_into_ii00113_in_csvs(belief_csv_strs, moment_rope) -> dict:
    ii00113_csv = ""
    for sheetname_key, csv_str in belief_csv_strs.items():
        if sheetname_key == "ii00128":
            ii00113_csv = transform_ii00129_into_ii00113_csv(csv_str, moment_rope)
    belief_csv_strs["ii00113"] = ii00113_csv
    return {
...
def transform_ii00129_into_ii00113_csv(csv_str: str, moment_rope: str):
