...
from ch20_brick.brick_db_tool import get_sheet_names
...
def test_create_lego0001_file_CreatesFile_Scenario0_NoMomentUnits(
    ...
    assert os_path_exists(lego0001_path) is False

    # WHEN
    create_lego0001_file(world_dir, output_dir, exx.sue)
...
def test_create_lego0001_file_CreatesFile_Scenario1_TranslateRowsInDB(
    temp3_fs,
):
    # ESTABLISH database with translate data
    bob_otx = "Bob"
    ...
    # WHEN
    create_lego0001_file(world_dir, output_dir, exx.yao, False)
