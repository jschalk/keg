...
from ch30_idea_dst.lego_db2df import (
    collect_lego0002_idea_csv_strs,
    create_lego0002_file,
)
...
def test_collect_lego0002_idea_csv_strs_ReturnsObj_Scenario0_NoMomentUnits(
    temp3_fs,
):
    # ESTABLISH
...
def test_collect_lego0002_idea_csv_strs_ReturnsObj_Scenario1_MomentUnitsDoesNotHaveSue(
    temp3_fs,
):
    # ESTABLISH
    world_dir = str(temp3_fs)
...
def test_collect_lego0002_idea_csv_strs_ReturnsObj_Scenario2_SingleMomentUnitHasSueJob(
    temp3_fs,
):
    # ESTABLISH
    world_dir = str(temp3_fs)
...
def test_create_lego0002_file_CreatesFile_Scenario0_NoMomentUnits(
    temp3_fs,
):
    # ESTABLISH
    world_dir = str(temp3_fs)
    output_dir = create_path(world_dir, "output")
    sue_lego0002_path = create_lego0002_path(output_dir, exx.sue)
    assert os_path_exists(sue_lego0002_path) is False

    # WHEN
    create_lego0002_file(world_dir, output_dir, exx.sue)
...
def test_create_lego0002_file_CreatesFile_Scenario1_Basic(
    temp3_fs,
):
    # ESTABLISH
    world_dir = str(temp3_fs)
