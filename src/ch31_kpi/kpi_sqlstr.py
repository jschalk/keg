...
FROM moment_tranbook_nets
LEFT JOIN person_planunit_job ON
  person_planunit_job.moment_rope = moment_tranbook_nets.moment_rope
  AND person_planunit_job.person_name = moment_tranbook_nets.person_name
GROUP BY moment_tranbook_nets.moment_rope, moment_tranbook_nets.person_name
;
"""
